...
public final class ThermalUtils {
    ...
    protected static final int STATE_ULTRACOOL = 9;
    ...
    private static final String THERMAL_ULTRACOOL = "thermal.ultracool=";
    ...
    private String getValue() {
        ...
        if (value == null || value.isEmpty()) {
            value = THERMAL_BENCHMARK + ":" + THERMAL_BROWSER + ":" + THERMAL_CAMERA + ":" +
                    ...
                    THERMAL_STREAMING + ":" + THERMAL_VIDEO + ":" + THERMAL_DEFAULT + ":" + THERMAL_ULTRACOOL;
            writeValue(value);
        }
        return value;
    }
    ...
    protected void writePackage(String packageName, int mode) {
        ...
        switch (mode) {
            ...
            case STATE_DEFAULT:
                ...
                break;
            case STATE_ULTRACOOL:
                modes[9] = modes[9] + packageName + ",";
                break;
        }
    ...
    protected int getStateForPackage(String packageName) {
        ...
        if (modes[0].contains(packageName + ",")) {
            ...
            state = STATE_DEFAULT;
        } else if (modes[9].contains(packageName + ",")) {
            state = STATE_ULTRACOOL;
        } else {
